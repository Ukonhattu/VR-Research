...
namespace VarjoExample
{
    ...
    public class VarjoGazeRay : MonoBehaviour
    {
        ...
        [Header("EyeTrackShowComponent")]
        public GameObject gazeCircle;
        private Vector3 gazeCircleOriginalScale;
        ...
        {
            gazeCircle.gameObject.transform.localScale = new Vector3(gazeCircleOriginalScale.x * (1 / (float)focusDistance), gazeCircleOriginalScale.y * (1 / (float)focusDistance), gazeCircleOriginalScale.z);
        }
    }
}
